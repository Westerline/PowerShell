...
# Great for PowerShell module and script testing.
# Lets you substitute one function with another function to test your functions with standard values or in environments where the functions don't behave normally.
# For example, you can use mock to test catch statements that don't often throw up errors. Or you can simulate an offline environment to test how your function will behave.
...
Describe "Mock" {
    ...
    #Tests how many times the mock function was called. Could be useful for something like testing the number of times a database connection has been opened.
    It "Used our Mock" {
